# ============================================================================
# 🐳 DOCKERFILE MULTI-ESTÁGIO - MICROSERVIÇO BATE-PAPO
# ============================================================================
#
# Dockerfile otimizado para microserviço reativo de chat com:
# - Multi-stage build para reduzir tamanho da imagem
# - Java 24 com JVM otimizada para containers
# - Usuário não-root para segurança
# - Health check nativo
# - Otimizações de performance para WebSockets/SSE
# - Suporte a debug remoto (desenvolvimento)
#
# Build: docker build -t conexaodesorte/batepapo:latest .
# Run: docker run -p 8083:8083 conexaodesorte/batepapo:latest
#
...
LABEL description="Microserviço de Bate-papo - Build Stage"
LABEL version="1.0.0"
...
# Configurar JVM otimizada para containers e WebSockets
ENV JAVA_OPTS="\
    -server \
    ...
    -Dspring.websocket.netty.max-frame-payload-length=65536"
...
LABEL org.opencontainers.image.title="Conexão de Sorte - Bate-papo"
LABEL org.opencontainers.image.description="Microserviço de Chat Reativo com WebSockets/SSE"
...
LABEL org.opencontainers.image.source="https://github.com/conexaodesorte/batepapo"
