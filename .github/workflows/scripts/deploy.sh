...
# ============================================================================
# 🚀 SCRIPT DE DEPLOY SIMPLIFICADO - CONEXÃO DE SORTE BATEPAPO
# ============================================================================
#
...
PROJECT_DIR="/opt/conexao-de-sorte/batepapo"
...
services:
  batepapo:
    image: ghcr.io/\${GITHUB_REPOSITORY:-conexao-de-sorte/conexao-de-sorte-backend-batepapo}-batepapo:\${IMAGE_TAG}
    ports:
      - "8080:8080"
    environment:
