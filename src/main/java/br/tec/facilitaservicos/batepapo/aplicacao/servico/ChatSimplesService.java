 ...
 */
@Service
public class ChatSimplesService {

    private static final Logger logger = LoggerFactory.getLogger(ChatSimplesService.class);

    private final RepositorioMensagemSimplesR2dbc repositorio;
    private final AuthServiceClient authServiceClient;

    public ChatSimplesService(RepositorioMensagemSimplesR2dbc repositorio, AuthServiceClient authServiceClient) {
