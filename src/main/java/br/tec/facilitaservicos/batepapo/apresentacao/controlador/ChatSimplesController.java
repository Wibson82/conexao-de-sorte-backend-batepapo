...
/**
 * Controlador simplificado de Chat - Versão Mínima Viável
 * 
 * Endpoints essenciais:
 * - POST /api/v1/chat/mensagens - Enviar mensagem
 * - GET /api/v1/chat/salas/{sala}/mensagens - Listar mensagens
 * - GET /api/v1/chat/salas/{sala}/status - Status da sala
 */
@RestController
@RequestMapping("/api/v1/chat")
@Tag(name = "Chat Simples", description = "API simplificada para chat em tempo real")
public class ChatSimplesController {

    private static final Logger logger = LoggerFactory.getLogger(ChatSimplesController.class);

    private final ChatSimplesService chatService;

    public ChatSimplesController(ChatSimplesService chatService) {
