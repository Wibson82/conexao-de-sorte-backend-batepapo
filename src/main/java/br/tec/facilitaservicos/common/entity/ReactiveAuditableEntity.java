package br.tec.facilitaservicos.common.entity;
 ...
 * 
 * Esta classe foi extraída para biblioteca compartilhada durante
 * a consolidação de microserviços para eliminar duplicações.
 * 
 * @author Sistema de Consolidação de Microserviços
 * @version 1.0
 * @since 2025
 */
